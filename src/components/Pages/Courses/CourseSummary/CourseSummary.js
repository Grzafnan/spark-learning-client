...
const CourseSummary = () => {
  ...
  return (
    <div className=' dark:bg-[#2e2e2e] py-10 dark:text-gray-100'>
      <div ref={ref} className=" w-3/4 lg:w-3/5 mx-auto p-4 shadow-md dark:bg-gray-900 dark:text-gray-100 rounded-lg">
