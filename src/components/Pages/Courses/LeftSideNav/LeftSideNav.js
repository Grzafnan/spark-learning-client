...
const LeftSideNav = () => {
  ...
  return (
    <>
      <div div className="h-full m-3 p-2 space-y-2  dark:bg-gray-900 dark:text-gray-100 border-[1px] shadow-lg border-blue-600 rounded md:w-64 w-11/12 lg:w-full mx-auto md:mx-0 " >
