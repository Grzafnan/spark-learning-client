      ...
      <div className=''>
        ...
        <div className="relative flex flex-col items-center justify-center sm:px-0 px-6 z-20 pb-32">
          ...
          <div className="lg:w-1/2 md:w-8/12 sm:w-9/12 w-full">
            <div className="bg-white dark:bg-[#1a1a1a] shadow rounded p-8">
              <div className=" flex items-center justify-between">
                <div>
                  <h2 className="text-base font-semibold leading-none text-gray-800  dark:text-white">What are the qualifications to be a Thinkful student?</h2>
                </div>
              ...
              {box1 && (
                <ul className="list-disc">
                  <h1 className='mt-4 dark:text-gray-100'>Admission to any Thinkful program is subject to the following qualifications:
                  </h1>
                  <li className=' ml-6'>
                    <p className="text-base leading-normal text-gray-600 dark:text-gray-100 mt-4 ">If you want to choose Pro or Business plan the you can use all payments. You can pay from Paypal, Payoneer, Master Card, Debit Card.</p>
                  </li>
                  <li className='ml-6 text-base leading-normal text-gray-600 dark:text-gray-100'>Students must be at least 18 years old.</li>

                  <li className='text-base leading-normal text-gray-600 dark:text-gray-100 ml-6'>Students must have proof of high school diploma or equivalent (GED), or a diploma from an institution of higher education accredited by an association recognized by the U.S. Department of Education. Thinkful will accept an attestation of the proper educational requirements.</li>

                  <li className='text-base leading-normal text-gray-600 dark:text-gray-100 ml-6'>
                  ...
                  <li className='text-base leading-normal text-gray-600 dark:text-gray-100 ml-6'> Students must demonstrate the ability to manage their time, communicate effectively with others, and accept constructive criticism.</li>

                </ul>
              )}
            </div>
            <div className="bg-white dark:bg-[#1a1a1a]  shadow rounded p-8 mt-8">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-base font-semibold leading-none text-gray-800  dark:text-white">What equipment do I need to get started?</h2>
                </div>
                <button
                  onClick={() => {
                    setBox2(!box2);
              ...
              {box2 && (
                <ul className='list-disc'>
                  <p className='mt-4 dark:text-gray-100 '>Thinkful does not have any physical classrooms or locations, as all our programs are entirely online. There is no physical campus and you aren’t required to attend any in person events. However, our programs do require a computer with a microphone, speakers, webcam, and high-speed internet access. We do not provide you with a computer, and every student must own or have access to a personal computer with at least 16GB RAM, at least 2.0 GHz processor (GPUs are not a requirement), and at least 256 GB HD. Additionally, the computer must be able to download applications and software; computers like Chromebooks will not work.
                  </p>
                  <p className='mt-4'>
                    For full-time programs, you're required to additionally provide the following equipment at your own cost:
                  </p>
                  <li className=' ml-6'>
                    <p className="text-base leading-normal text-gray-600 dark:text-gray-100 mt-4 ">A reliable Mac or PC with video capability including a webcam and microphone. Headphones are highly recommended. Macs must have the most current OS version installed, and PCs must be using Windows 10 or newer operating systems. </p>
                  </li>
                  <li className='ml-6 text-base leading-normal text-gray-600 dark:text-gray-100'>Reliable internet connection fast enough to stream video sessions clearly for upwards of 8 hours a day. </li>
            ...
            <div className="bg-white dark:bg-[#1a1a1a] shadow rounded p-8 mt-8">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-base font-semibold leading-none text-gray-800  dark:text-white">Is Thinkful an accredited institution?</h2>
                </div>
                <button
                  onClick={() => {
                    setBox3(!box3);
              ...
              {box3 && (
                <ul>
                  <li>
                    <p className="text-base leading-normal text-gray-600 dark:text-gray-100 mt-4 ">Thinkful, Inc. is not accredited by a regional or national accrediting agency recognized by the United States Department of Education. Thinkful, Inc. has not received a provisional approval and is not offering an unaccredited degree program. Thinkful, Inc. is not eligible to participate in federal student financial assistance programs.</p>
                  </li>
                </ul>
              )}
            </div>
            <div className="bg-white dark:bg-[#1a1a1a] shadow rounded p-8 mt-8">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-base font-semibold leading-none text-gray-800  dark:text-white">Do Thinkful certificates translate to credits applicable towards a Bachelor's or Master’s of Science degree?</h2>
                </div>
