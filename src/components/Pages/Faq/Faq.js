            ...
            <div className="bg-white shadow rounded p-8">
              ...
              {box1 && (
                <ul className="list-disc">
                  <h1 className='mt-4 dark:text-gray-600'>Admission to any Thinkful program is subject to the following qualifications:
                  </h1>
                  <li className=' ml-6'>
