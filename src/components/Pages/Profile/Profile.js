        ...
        user && user?.emailVerified ? <div className="flex justify-center my-10 md:my-20" >
          <div className="flex flex-col justify-center w-10/12 md:w-2/4 lg:w-2/5 p-6 shadow-xl rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
            <div className="flex justify-between items-center mb-12">
              ...
              <div className="flex items-center justify-center">
                <button
                  type="button"
                  onClick={openModal}
                  className=" bg-blue-500 px-[12px] py-[4px] text-sm  text-white  focus-visible:ring-2  focus-visible:ring-opacity-75 text-md font-bold  rounded-full  hover:bg-blue-600"
                >
                  Edit
                </button>
              </div>
            ...
            <div>
              ...
              } alt={user?.displayName} className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
            </div>
            <div className="space-y-6 text-center divide-y divide-gray-700">
              <div className="my-2 space-y-1">
                <h2 className="text-xl font-semibold sm:text-2xl">
                  {user?.displayName}
                </h2>
                <p className="px-5 text-xs sm:text-base dark:text-gray-400">Email: {user?.email}</p>
                <p className="px-5 text-xs sm:text-base dark:text-gray-400">ID: {user?.uid}</p>
              </div>
          ...
          :
          <>
            <h1 className='text-4xl text-blue-600 font-bold text-center mt-10'>User Profile</h1>
            <div className="w-[80%] md:w-[40%] mx-auto my-32 p-8 bg-gray-200 text-black">
              <h1>Verfiy Email address first, to see your full Profile Information.</h1>
            </div>
          </>
      }
