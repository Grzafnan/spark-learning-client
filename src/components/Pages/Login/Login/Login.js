...
const Login = () => {
  ...
  return (
    <section className="dark:bg-[#2e2e2e]  xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 flex items-center justify-center ">
      <div className=" dark:bg-gray-900  bg-white shadow-xl rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
        <p tabIndex={0} className="focus:outline-none text-2xl font-extrabold leading-6 dark:text-white text-gray-800">
          Login to your account
        </p>
        <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none dark:text-white text-gray-500">
          Dont have account?{" "}
          <Link to='/register' className="dark:text-white hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-gray-800 cursor-pointer">
            {" "}
            Sign up
          </Link>
        </p>
        <button onClick={signInWithGoogle} aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-gray-100 ">
          ...
          <p className="text-base font-medium ml-4 text-gray-700 dark:text-white">Continue with Google</p>
        </button>
        <button onClick={signInWithGithub} aria-label="Continue with github" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-100">
          ...
          <p className="text-base font-medium ml-4 text-gray-700 dark:text-white">Continue with Github</p>
        </button>

        <div className="w-full flex items-center justify-between py-5">
          <hr className="w-full bg-gray-400" />
          <p className="text-base font-medium leading-4 px-2.5 text-gray-500 dark:text-white">OR</p>
          <hr className="w-full bg-gray-400" />
        </div>
        <form onSubmit={handelSignIn}>
          <div>
            <label htmlFor="email" className="text-sm font-medium leading-none dark:text-white text-gray-800">
              {" "}
              Email{" "}
            </label>
          ...
          <div className="mt-6 w-full">
            <label htmlFor="myInput" className="text-sm font-medium leading-none dark:text-white text-gray-800">
              {" "}
              Password{" "}
            </label>
            ...
            <p className='text-end dark:text-white hover:text-blue-600'>
